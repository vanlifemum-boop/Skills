# Reel 3 — Vertrauen wurde gebrochen

**Cover:** `VERTRAULICH HEISST VERTRAULICH`  
...
|---|---|---|---|
| 0:00–0:08 | `C03` | `cover-reel3-vertraulich.png` | verschlossenes Tagebuch, roter Pfeil zerbricht den Schutzkreis |
| 0:08–0:16 | `B04` | `beleg-b4-streit-anonym.png` | WhatsApp 4. Juli 2026, Streitverlauf — Avatar abgedeckt |
...
**`B04`** — `beleg-b4-streit-anonym.png`
...
| Von | Bis | Text | Farbe |
|---|---|---|---|
| 0:00 | 0:04 | VERTRAULICH HEISST VERTRAULICH | weiß, groß |
| 0:04 | 0:09 | Mütter sprechen über Kinder, Behörden, Ängste. | weiß |
| 0:09 | 0:14 | Das wird im Vertrauen geteilt — | weiß |
| 0:14 | 0:18 | und gehört in keinen anderen Chat. | weiß |
| 0:18 | 0:21 | VERTRAUEN IST KEIN FREIFAHRSCHEIN. | rot |
| 0:21 | 0:24 | PRIVATE GESCHICHTEN SIND KEINE WAFFE. | cyan |
