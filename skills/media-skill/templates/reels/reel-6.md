# Reel 6 — Die klare Warnung

**Cover:** `KEINE HETZJAGD. KLARE WARNUNG.`  
...
|---|---|---|---|
| 0:00–0:08 | `C05` | `cover-reel6-hetzjagd.png` | Mutter-Kind-Silhouette, Stoppschild, rote Nachrichtenfäden |
| 0:08–0:16 | `B01` | `beleg-b1-sms.png` | SMS: „Klage oder Strafanzeige?" |
...
| Von | Bis | Text | Farbe |
|---|---|---|---|
| 0:00 | 0:04 | KEINE HETZJAGD. KLARE WARNUNG. | weiß, groß |
| 0:04 | 0:09 | Das ist kein Aufruf, jemanden anzugreifen. | weiß |
| 0:09 | 0:14 | Es ist eine Schutzwarnung: | weiß |
| 0:14 | 0:18 | Keine sensiblen Unterlagen weitergeben. | weiß |
| 0:18 | 0:21 | NICHT ANSCHREIBEN. NICHT BEDROHEN. | rot |
| 0:21 | 0:24 | MÜTTER SCHÜTZEN MÜTTER. | cyan |
